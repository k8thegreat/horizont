...
foreach ($arResult['SECTIONS'] as &$arSection){
    ...
    if($arSection["PICTURE"]){
        ...
        $file = CFile::ResizeImageGet($arSection["PICTURE"], array('width'=>290, 'height'=>230), BX_RESIZE_IMAGE_EXACT, true);
        $arSection["PICTURE"] = $img = '<img src="'.$file['src'].'" width="'.$file['width'].'" height="'.$file['height'].'" />';
    }
    $arFilter = Array(
        "IBLOCK_ID"=>$arParams["IBLOCK_ID"],
        "ACTIVE"=>"Y",
