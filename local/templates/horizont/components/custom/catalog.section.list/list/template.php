                        ...
                        <div class="result-content">
                            ...
                            <div class="result-dop-con">
                                <ul class="left-con">
                                    ...
                                    <li>
                                        <div class="loc-data">
                                            <?=TIME_ICON?><?=$arSection["UF_TIME_ON_FOOT"]?> мин <?=FOOT_ICON?>
                                        </div>
                                    </li>
                                    <?}?>
                                    <?if($arSection["UF_TIME_ON_TRANSPORT"]){?>
                                        <li>
                                            <div class="loc-data">
                                                <?=TIME_ICON?><?=$arSection["UF_TIME_ON_TRANSPORT"]?> мин <?=TRANSPORT_ICON?>
                                            </div>
                                        </li>
                                    <?}?>
                                </ul>
                                <ul class="left-con">
                                    <?if($arSection["UF_READY"]){?>
                                        ...
                                        <?=(count($arSection["UF_READY"])>1 ? "<b>".formatReadyDate($arSection["UF_READY"][0])." - ".formatReadyDate($arSection["UF_READY"][count($arSection["UF_READY"])-1])."</b>" : "<b>".formatReadyDate($arSection["UF_READY"][0], true)."</b>")?>
                                    </li>
                                    <?}?>
