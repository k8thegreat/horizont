            ...
            <div class="result-list tile-mod">
                <div class="result-list-nav">
                    <div>
                        ...
                        <a href="new-builders.php" class="list list-squares active">
                        ...
                        <div class="result-content-top">
                            ...
                            <div>
                                ...
                                <div class="loc-data">
                                    ...
                                    15 мин
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 93.646 93.646" fill="#d4d4d5" xml:space="preserve" width="14px" height="14px">
                                    <g>
                ...
                <div>
                    <div class="one-result text-mod">
                        ...
                        <p>Вы получаете полноценную беспристрастную информацию о рынке новостроек, в отличие от
                            застройщика, который заинтересован в продаже только своих объектов</p>
